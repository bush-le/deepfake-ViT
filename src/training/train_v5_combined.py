...
if __name__ == "__main__":
    ...
    parser.add_argument("--train-csv", type=str, default=str(PROJECT_ROOT / "data/splits/train_v5_combined_universal_kaggle_boost.csv"))
    parser.add_argument("--val-csv", type=str, default=str(PROJECT_ROOT / "data/splits/val_v5_combined_universal_kaggle_boost.csv"))
