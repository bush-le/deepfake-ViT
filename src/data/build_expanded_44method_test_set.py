...
TRAIN_CSV = PROJECT_ROOT / "data/splits/train_v5_weakfix_v3.csv"
TEST_OLD_CSV = DATA_ROOT / "zero_leakage_benchmark_fixed/test_balanced_fixed_zero_leakage.csv"
TEST_DATA_V3_MANIFEST = DATA_ROOT / "test_data_v3/manifest.csv"
KAGGLE_TEST_DIR = DATA_ROOT / "kaggle/philosopher0808/real-vs-ai-generated-faces-dataset/versions/1/dataset/dataset/test"
DF40_TEST_FULL_DIR = DATA_ROOT / "df-40-test-full"
...
def main():
        ...
        with open(TEST_DATA_V3_MANIFEST, "r", encoding="utf-8") as f:
            ...
            for r in reader:
                ...
                if not p.startswith("/") and not (len(p) > 1 and p[1] == ":"):
                    full_p = str(DATA_ROOT / "test_data_v3" / p)
                else:
                    full_p = p
    ...
    dff_dir = DATA_ROOT / "deepFaceFake"
    if dff_dir.exists():
        dff_count = 0
    ...
    dffs_test_dir = DATA_ROOT / "deep-fake-face-swap/images/test"
    ...
    celeb_test_dir = DATA_ROOT / "processed/celeb_df_test_extracted"
