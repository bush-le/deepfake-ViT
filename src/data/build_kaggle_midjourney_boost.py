...
def build_kaggle_midjourney_boost(
    kaggle_source: str = "/workspace/data/kaggle/philosopher0808/real-vs-ai-generated-faces-dataset/versions/1/data_source/data_source",
    output_csv: str = "/workspace/data/zero_leakage_benchmark_fixed/train_kaggle_midjourney_boost_12k.csv",
    seed: int = 42,
):
    ...
    assert kaggle_base.exists(), f"Kaggle data source directory not found at {kaggle_base}"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--kaggle-source",
        type=str,
        default="/workspace/data/kaggle/philosopher0808/real-vs-ai-generated-faces-dataset/versions/1/data_source/data_source",
        help="Path to Kaggle data_source folder",
    )
    parser.add_argument(
        "--output-csv",
        type=str,
        default="/workspace/data/zero_leakage_benchmark_fixed/train_kaggle_midjourney_boost_12k.csv",
