...
def main():
    ...
    for m_name in ['starganv2', 'CollabDiff']:
        m_dir = DATA / f'df-40-test-full/{m_name}/fake'
        if m_dir.exists():
    ...
    dffs_dir = DATA / 'deep-fake-face-swap'
    if dffs_dir.exists():
    ...
    sfhq_dir = DATA / 'kaggle/philosopher0808/real-vs-ai-generated-faces-dataset/versions/1/data_source/data_source/sfhq/studio'
    if sfhq_dir.exists():
    ...
    sd_dir = DATA / 'kaggle/philosopher0808/real-vs-ai-generated-faces-dataset/versions/1/data_source/data_source/stable_diffusion'
    if sd_dir.exists():
    ...
    if len(clean_candidates) == 0:
        print("⚠️ No clean candidate frames found on disk. Skipping split generation.")
        return
