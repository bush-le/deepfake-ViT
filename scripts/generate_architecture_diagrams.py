"""
Generate crisp, publication-grade architectural PNG diagrams corresponding to all Mermaid diagrams in THEORY_AND_MODEL_COMPARISON.md.
...
OUT_DIR = Path("experiments/results/diagrams")
...
# Title
ax.text(50, 47, "End-to-End Deepfake Forensics Pipeline Architecture", 
...
ax.add_patch(b2a)
ax.text(41, 37, "Meta DINOv3 ViT-S/16", fontsize=9, fontweight='bold', ha='center', color=SECONDARY)
ax.text(41, 33, "21.60M Params | Patch 16x16", fontsize=7.5, ha='center', color=DARK_TEXT)
ax.text(41, 29, "12 Layers | 6 Heads | Dim 384", fontsize=7.5, ha='center', color=DARK_TEXT)
ax.text(41, 26, "Global Multi-Head Attention", fontsize=7.5, fontweight='bold', ha='center', color=PRIMARY)
...
# Box 4: Ensemble
b4 = patches.FancyBboxPatch((78, 15), 19, 20, boxstyle="round,pad=1", 
                            fc="#f4ecf7", ec="#8e44ad", lw=1.8)
ax.add_patch(b4)
ax.text(87.5, 31, "Joint Late Ensemble", fontsize=9, fontweight='bold', ha='center', color="#8e44ad")
ax.text(87.5, 27, "P = 0.65·ViT + 0.35·CNN", fontsize=7.5, fontweight='bold', ha='center', color=PRIMARY)
ax.text(87.5, 23, "Test Acc: 97.88%", fontsize=8, fontweight='bold', ha='center', color=ACCENT)
ax.text(87.5, 19, "ROC-AUC: 99.74%", fontsize=8, fontweight='bold', ha='center', color=SECONDARY)
ax.text(87.5, 16, "Latency: 13.36 ms", fontsize=7.5, ha='center', color=DARK_TEXT)
...
ax.text(22, 7.5, "=> Recommended: Meta DINOv3 ViT-S/16", fontsize=7.5, fontweight='bold', ha='center', color=PRIMARY)
...
ax.text(78, 7.5, "=> Recommended: DINOv3 ConvNeXt-Tiny", fontsize=7.5, fontweight='bold', ha='center', color=PRIMARY)
...
ax.text(74.5, 9.5, "• CNN: 97.12% Acc (Saturates earlier)", fontsize=7.5, ha='center', color=DARK_TEXT)
ax.text(74.5, 7, "• ViT: 97.64% Acc (Scales to SOTA)", fontsize=7.5, fontweight='bold', ha='center', color=SECONDARY)
